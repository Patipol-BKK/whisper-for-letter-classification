...
for snr in snr_range:
	...
	wflc_small_config = WflcConfigs.get_config('wflc_base')
	...
	torch.save({
		...
		},f'models/wflc_base_snr{snr}_{num_samples}_aug10_nofreeze_best.npz')

	torch.save({
			'model_state_dict': wflc_small.state_dict(),
		},f'models/wflc_base_snr{snr}_{num_samples}_aug10_nofreeze_last.npz')

	np.save(f'models/wflc_base_snr{snr}_{num_samples}_aug10_nofreeze_losses.npy', np.array(loss, dtype=object), allow_pickle=True)